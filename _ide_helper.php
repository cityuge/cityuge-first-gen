...
namespace {
	...
	class Profiler extends \Sebklaus\Profiler\Facades\Profiler{
		/**
		 * 
		 *
		 * @static 
		 */
		 public static function __construct($time){
			//Method inherited from \Sebklaus\Profiler\Profiler
			 \Sebklaus\Profiler\Profiler::__construct($time);
		 }
		 ...
		 */
		 public static function getViewData(){
			//Method inherited from \Sebklaus\Profiler\Profiler
			return \Sebklaus\Profiler\Profiler::getViewData();
		 }
		 ...
		 */
		 public static function setViewData($data){
			//Method inherited from \Sebklaus\Profiler\Profiler
			 \Sebklaus\Profiler\Profiler::setViewData($data);
		 }
		 ...
		 */
		 public static function outputData(){
			//Method inherited from \Sebklaus\Profiler\Profiler
			return \Sebklaus\Profiler\Profiler::outputData();
		 }
		 ...
		 */
		 public static function cleanArray($data){
			//Method inherited from \Sebklaus\Profiler\Profiler
			return \Sebklaus\Profiler\Profiler::cleanArray($data);
		 }
		 ...
		 */
		 public static function getMemoryUsage(){
			//Method inherited from \Sebklaus\Profiler\Profiler
			return \Sebklaus\Profiler\Profiler::getMemoryUsage();
		 }
		 ...
		 */
		 public static function addLog($type, $message){
			//Method inherited from \Sebklaus\Profiler\Profiler
			 \Sebklaus\Profiler\Profiler::addLog($type, $message);
		 }
		 ...
		 */
		 public static function start($key){
			//Method inherited from \Sebklaus\Profiler\Profiler
			 \Sebklaus\Profiler\Profiler::start($key);
		 }
		 ...
		 */
		 public static function end($key){
			//Method inherited from \Sebklaus\Profiler\Profiler
			 \Sebklaus\Profiler\Profiler::end($key);
		 }
