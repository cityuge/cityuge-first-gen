    ...
    <div class="row">
        ...
        <nav id="links" class="col-sm-3">
            <div class="list-group">
                <a href="http://www.cityu.edu.hk/ug/current/course/{{ $course->code }}.htm" target="_blank" class="list-group-item">{{ trans('app.course_form2b') }} <i class="fa fa-external-link"></i></a>
